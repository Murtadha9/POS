...
const QuastionMark = ({ openModal, setOpenModal }) => {
  return (
    ...
    <div className='flex flex-col items-center w-96 h-96 bg-white p-6 rounded-md'>
      ...
      <div className='flex justify-center w-full'>
        <button onClick={() => setOpenModal(false)} className='bg-red-400 text-white p-2 rounded-md mx-2'>
          خروج
        </button>
